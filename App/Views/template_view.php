...
<nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-sm-2  mr-0" href="#">Phone Book</a>
    <input class="form-control form-control-dark mr-1 col-sm-3" type="text" placeholder="Search" aria-label="Search">
    <!--
